        ...
        <main class="flex-1">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <form id="addBookForm" class="bg-white/5 dark:bg-black/5 rounded-xl p-6 shadow-lg space-y-4"
                    ...
                    <!-- Photo de couverture -->
                    <div class="form-group">
                        {{-- <div class="h-48 w-28 bg-red-600"><img src="{{ $book->photo ? asset('storage/' . $book->photo) : asset('images/default-avatar.jpg') }}" alt="" class="w-full h-full cover object-cover object-center"></div> --}}
