            ...
            <div class="w-full max-w-md mx-auto" data-aos="zoom-in-right">
                    ...
                    <form class="space-y-6" action="{{ route('auth.login.store') }}" method="POST">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <label class="flex items-center">
                                <input type="checkbox"
                                    class="rounded border-light-primary/20 dark:border-dark-primary/20 text-light-primary dark:text-dark-primary focus:ring-light-accent dark:focus:ring-dark-accent">
                ...
                <div class="mt-8 text-center">
                    ...
                    <div class="flex justify-center space-x-4">
                        <button
                            class="p-3 rounded-full bg-light-secondary/10 dark:bg-dark-secondary/10 hover:scale-110 transition-all duration-300">
